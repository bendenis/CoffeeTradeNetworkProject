...
library(tidyverse)
source("/Users/bendenisshaffer/Box Sync/UM Fall 2017/SI 608/CoffeeTradeNetworkProject/DataFormating/ScrapeClean/get_Comtrade.R")
...
write.csv(DT, file = "/Users/bendenisshaffer/Box Sync/UM Fall 2017/SI 608/CoffeeTradeNetworkProject/Data/Scraped/coffee_trade.csv")
